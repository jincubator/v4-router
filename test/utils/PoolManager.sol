    ...
    Exttload
{
        ...
        returns (BalanceDelta callerDelta, BalanceDelta feesAccrued)
    {
        ...
        emit ModifyLiquidity(
            id, msg.sender, params.tickLower, params.tickUpper, params.liquidityDelta, params.salt
        );
    ...
    function _accountPoolBalanceDelta(PoolKey memory key, BalanceDelta delta, address target)
        internal
    {
